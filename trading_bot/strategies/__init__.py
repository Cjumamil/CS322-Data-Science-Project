...
DEFAULT_STRATEGY_CONFIGS = {
    ...
    "vwap_rsi_mean_reversion": {
        ...
        "min_distance_from_vwap_frac": 0.002,
...
def create_strategy(strategy_config: dict):
    ...
    if name == "vwap_rsi_mean_reversion":
        return VwapRsiMeanReversionStrategy(
            ...
            min_distance_from_vwap_frac=float(strategy_config.get("min_distance_from_vwap_frac", 0.002)),
            ...
            max_bars_in_trade=int(strategy_config.get("max_bars_in_trade", 15)),
